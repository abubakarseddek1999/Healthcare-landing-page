...
const HelpSection = () => {
    return (
        <div className='md:grid grid-cols-2  gap-10 max-w-[1400px] mx-auto p-4 my-24'>
            <div className='md:w-4/5'>
                <div className="p-2 text-center border w-24 rounded-xl border-indigo-400 mb-5">Who we are</div>

                <p className='text-2xl md:text-4xl font-bold mb-5'>We Help To Get Soultions</p>
                ...
                <div className="bg-[#FFC637]  text-xl border-4 border-black-600 w-[200px] font-bold rounded-xl flex justify-center items-center mb-2 p-2">
                    Appointment
                    <FiArrowUpRight />
                </div>
            ...
            <div>
                <div className='relative'>
                    ...
                    <div className='absolute bg-[#343268] text-white p-5 lg:p-10   rounded-xl md:-bottom-8 md:-left-20 md:right-56 -bottom-20'>
